...
def main():
    ...
    is_dtensor_checkpoint = isinstance(weight, torch.distributed._tensor.DTensor)

    if not is_dtensor_checkpoint:
        print("Detected a non-sharded checkpoint; exporting directly to Hugging Face format.")
